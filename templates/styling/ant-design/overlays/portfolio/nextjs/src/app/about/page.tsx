        ...
        <Card style={{ marginBottom: 32 }}>
          <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
            ...
            <Paragraph style={{ margin: 0 }}>
              I am a passionate software engineer with a love for building beautiful, performant web applications.
              With expertise in modern JavaScript frameworks and a keen eye for design, I bridge the gap between functionality and aesthetics.
            </Paragraph>
          </div>
        </Card>
