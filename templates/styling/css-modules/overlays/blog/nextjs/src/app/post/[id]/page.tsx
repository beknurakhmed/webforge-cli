  ...
  if (!post) {
    return (
      <div className={styles.notFound}>
        ...
        <Link href="/" className={styles.btnPrimary}>Back to Blog</Link>
      </div>
    );
  }
    ...
    <div className={styles.postDetailPage}>
      <div className={styles.blogLayout}>
        <article className={styles.postArticle}>
          <Link href="/" className={styles.backLink}>← Back to Blog</Link>
          ...
          <div className={styles.postHeroImage}>{post.image}</div>
