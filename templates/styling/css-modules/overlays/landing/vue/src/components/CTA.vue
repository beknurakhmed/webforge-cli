<template>
  <section id="cta" :class="$style.cta">
    <div :class="$style.ctaContent">
      <h2>Ready to Get Started?</h2>
      <p>Join thousands of developers building amazing products.</p>
      <button :class="[$style.btn, $style.btnPrimary, $style.btnLarge]">Start Free Trial</button>
      <p :class="$style.note">No credit card required</p>
    </div>
  </section>
</template>
...
.ctaContent { max-width: 600px; margin: 0 auto; }
...
.btnLarge { padding: 1rem 2.5rem; font-size: 1.1rem; }
</style>
