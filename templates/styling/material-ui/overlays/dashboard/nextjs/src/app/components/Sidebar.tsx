...
import {
  Drawer, List, ListItemButton, ListItemIcon, ListItemText, Typography, Box, Avatar,
} from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <Box sx={{ p: 2, borderTop: '1px solid #374151', display: 'flex', alignItems: 'center', gap: 1.5 }}>
        ...
        <Box>
          <Typography variant="body2" sx={{ color: '#ffffff', fontWeight: 500 }}>Admin User</Typography>
          <Typography variant="caption" sx={{ color: '#6b7280' }}>Administrator</Typography>
        </Box>
      </Box>
    </Drawer>
  );
