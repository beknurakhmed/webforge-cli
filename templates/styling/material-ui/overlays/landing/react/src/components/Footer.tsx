        ...
        <Grid2 container spacing={4}>
          ...
          <Grid2 size={{ xs: 6, md: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              ...
              <Link href="#" underline="hover" sx={{ color: '#9ca3af', fontSize: '0.9rem', '&:hover': { color: '#ffffff' } }}>Documentation</Link>
            </Box>
          </Grid2>
          <Grid2 size={{ xs: 6, md: 2 }}>
            <Typography variant="subtitle2" sx={{ color: '#ffffff', textTransform: 'uppercase', letterSpacing: '0.05em', mb: 1 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              ...
              <Link href="#contact" underline="hover" sx={{ color: '#9ca3af', fontSize: '0.9rem', '&:hover': { color: '#ffffff' } }}>Contact</Link>
            </Box>
          </Grid2>
          <Grid2 size={{ xs: 6, md: 2 }}>
            <Typography variant="subtitle2" sx={{ color: '#ffffff', textTransform: 'uppercase', letterSpacing: '0.05em', mb: 1 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              <Link href="#" underline="hover" sx={{ color: '#9ca3af', fontSize: '0.9rem', '&:hover': { color: '#ffffff' } }}>Privacy Policy</Link>
              <Link href="#" underline="hover" sx={{ color: '#9ca3af', fontSize: '0.9rem', '&:hover': { color: '#ffffff' } }}>Terms of Service</Link>
            </Box>
          </Grid2>
        </Grid2>
